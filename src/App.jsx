...
export default function App() {
 ...
 const [timezones, settimezones] = useState([])
  ...
  const onSubmit = async (data) => {
    ...
    let a = await fetch("https://timzone-calculator-production.up.railway.app/moderators/add", {
      headers: {
  ...
  useEffect(() => {
    ...
    async function getTimezone() {
      let a = await fetch("https://timzone-calculator-production.up.railway.app/timezones")
